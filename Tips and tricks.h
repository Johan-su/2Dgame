...
int main2312323(int argc, char* argv[])
{
    ...
    blitting. */
    Loading_Surf = SDL_LoadBMP("resources/texture/test_tile.bmp");
    ...
    Loading_Surf = SDL_LoadBMP("resources/texture/test_aokadkasdkoaskdlöasökldtile.bmp");
